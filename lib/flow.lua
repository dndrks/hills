...
function f_m.draw_menu()
  ...
  elseif _fm_.menu_layer == 3 then
    ...
    elseif _fm_.main_sel == 3 then
      ...
      screen.level(3)
      local sel_x = 70+(f_m.index_to_grid_pos(_fm_.song_col[_fm_.voice],3)[1]-1)*28
      ...
      for i = 1+(15*page), 15+(15*page) do
        screen.move(76+(f_m.index_to_grid_pos(util.wrap(i,1,15),3)[1]-1)*28,10+(10*f_m.index_to_grid_pos(util.wrap(i,1,15),3)[2]))
...
function f_m.process_encoder(n,d)
  ...
  elseif _fm_.menu_layer == 3 then
    ...
    elseif _fm_.main_sel == 3 then
      ...
      elseif n == 2 then
        if _fm_.song_col[_fm_.voice] == 2 then
          if d > 0 then
            ...
            _fm_.song_col[_fm_.voice] = util.clamp(_fm_.song_col[_fm_.voice] + d,1,3)
          end
        -- elseif _fm_.song_col[_fm_.voice] == 2 then
        --   _fm_.song_col[_fm_.voice] = util.clamp(_fm_.song_col[_fm_.voice] + d,1,4)
        elseif _fm_.song_col[_fm_.voice] == 1 then
          if d < 0 then
            local current_line = _fm_.song_line[_fm_.voice]
            _fm_.song_line[_fm_.voice] = util.clamp(_fm_.song_line[_fm_.voice] + d,1,song_atoms[_fm_.voice].end_point)
            if (_fm_.song_line[_fm_.voice] ~= song_atoms[_fm_.voice].start_point) and (_fm_.song_line[_fm_.voice] ~= song_atoms[_fm_.voice].end_point) then
              _fm_.song_col[_fm_.voice] = 2
            elseif current_line ~= _fm_.song_line[_fm_.voice] then
              _fm_.song_col[_fm_.voice] = 2
            end
          else
      ...
      elseif n == 3 then
        ...
        elseif _fm_.song_col[_fm_.voice] == 2 then
          -- song_atoms[_fm_.voice].lane[_fm_.song_line[_fm_.voice]][pattern_names[_fm_.song_col[_fm_.voice]-1]].target = util.clamp(song_atoms[_fm_.voice].lane[_fm_.song_line[_fm_.voice]][pattern_names[_fm_.song_col[_fm_.voice]-1]].target + d,-1,16)
          song_atoms[_fm_.voice].lane[_fm_.song_line[_fm_.voice]][pattern_names[_fm_.song_col[_fm_.voice]-1]].target = util.clamp(song_atoms[_fm_.voice].lane[_fm_.song_line[_fm_.voice]][pattern_names[_fm_.song_col[_fm_.voice]-1]].target + d,0,16)
