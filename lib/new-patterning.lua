...
function patterning.init()
  ...
  for i = 1,4 do
    pattern[i] = main_lattice:new_pattern{
      ...
      division = 1/256 -- this allows the sub_steps to run at 16th notes
    }
    ...
    for j = 1,1024 do
      ...
      pattern[i].sub_steps.max[j] = 16 -- 16 pulses per 1/16 step
    end
